...
xTuilesElement.lifecycle = {
    ...
    inserted: function () {
        ...
        document.getElementById("mode-toggler-text").onclick = this.toggleMode.bind(this);
        document.getElementById("mode-toggler-manual").onclick = this.toggleMode.bind(this);
